...
public class CSVComparatorView2 extends JFrame{
	 ...
	 * @param controller2 
	 */
	public CSVComparatorView2(MainController controller) {
		initialize();
	...
	private void initialize() {
		...
		btnCompare.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				controller.compare(file1, file2, ufile1, ufile2, path, searchKey.getText());
			}
		});
